...
public class Password {
    ...
    public String generaPassword (){
        ...
        for (int i=0;i<longitudcontrasenya;i++){
            ...
            if (eleccion==1){
                password=generaMinuscula(password);
            }else{
                if(eleccion==2){
                    password=generaMayuscula(password);
                }else{
    ...
    public static String generaMinuscula(String password){
        char minusculas=(char)((int)Math.floor(Math.random()*(123-97)+97));
        password+=minusculas;
        return password;
    }
    public static String generaMayuscula(String password){
        char mayusculas=(char)((int)Math.floor(Math.random()*(91-65)+65));
        password+=mayusculas;
        return password;
    }
    public static String generaNumeros(String password){
